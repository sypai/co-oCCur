...
#ifndef CO_OCCUR_BASE64STRINGS_H
#define CO_OCCUR_BASE64STRINGS_H

#include <string>

namespace co_oCCur {

    static const char kBase64Chars[65] = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/";
...
#endif //CO_OCCUR_BASE64STRINGS_H
